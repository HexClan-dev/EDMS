 ...
 */
class Payments extends \AppBundle\Entity\Payments implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Payments' . "\0" . 'dateP', '' . "\0" . 'AppBundle\\Entity\\Payments' . "\0" . 'academicYear', '' . "\0" . 'AppBundle\\Entity\\Payments' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\Payments' . "\0" . 'notes', '' . "\0" . 'AppBundle\\Entity\\Payments' . "\0" . 'amount', '' . "\0" . 'AppBundle\\Entity\\Payments' . "\0" . 'type', '' . "\0" . 'AppBundle\\Entity\\Payments' . "\0" . 'isprocessed', '' . "\0" . 'AppBundle\\Entity\\Payments' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Payments' . "\0" . 'student'];
        }
    ...
    public function isIsprocessed()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isIsprocessed', []);

        return parent::isIsprocessed();
    }
