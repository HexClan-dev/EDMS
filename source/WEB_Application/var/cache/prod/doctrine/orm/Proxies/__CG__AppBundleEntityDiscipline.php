 ...
 */
class Discipline extends \AppBundle\Entity\Discipline implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Discipline' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\Discipline' . "\0" . 'points', '' . "\0" . 'AppBundle\\Entity\\Discipline' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Discipline' . "\0" . 'student'];
        }
