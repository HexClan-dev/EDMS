...
//      $em->remove($user_id->getStudentMappedEvents());
    ...
    public function addAssistantsAction(Request $request){
        ...
        // adirector/show/info/ssign to an academic semester
...
//        $your_events = $user->getStudentMappedEvents();
    ...
    /**
     * @Route("/director/event/participating/{eventParticiating}", name="invited_events")
     */
...
//        ));
    ...
    public function add_academicYearAction(Request $request){
        ...
        if($availibility){
            $this->addFlash('failure','The Academic year, actually exists during this period. !!');
            return $this->redirectToRoute('academic_year');
        }
...
//        $availibility = $em->getRepository('AppBundle:AcademicYear')->checkIfItisAvailable();
    ...
    /**
     * @Route("/director/profile/show", name="director_show_profile")
     */
    ...
    /**
     * @Route("/director/profile/edit", name="director_edit_profile")
     */
