...
class DefaultController extends Controller
{
    ...
    {
        $rd = $this->checkIfTheUserIsPreloggedIn();
        if($rd != null)
            return $rd;
    ...
    public function applicationFormAction(Request $request){
        ...
        if($form->isSubmitted() && $form->isValid()){
            ...
            if(!$academic_year){
                $this->addFlash('failure','There was a problem with your application, no opened academic semester!!');
            ...
            {
                $this->addFlash('failure','There was a problem with your applciation!!'.$e->getMessage());
            }
            return $this->redirectToRoute('homepage');
        }
    ...
    private function checkIfTheUserIsPreloggedIn(){
